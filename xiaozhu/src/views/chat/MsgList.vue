	...
	<div class="msg-list chatBody">
		<div class="msg-list-container" v-if="msglist">
			<van-swipe-cell v-for="(item,i) in msglist" :key="i">
				<van-cell is-link :to="`/msg/chat?chatid=${i}&oid=${item.Owner.oid}`">
					<!-- 使用 title 插槽来自定义标题 -->
					<template #title>
						<div class="msg-list-item">
							<img :src="item.Owner.oImg ? item.Owner.oImg : '/default.png'" alt="">
							<div class="msg-last">
								<span>{{item.Owner.oname}}</span>
